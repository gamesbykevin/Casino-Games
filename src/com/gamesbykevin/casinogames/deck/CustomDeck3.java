...
public final class CustomDeck3 extends Deck
{
    ...
    private static final int SOURCE_WIDTH = 212;
    private static final int SOURCE_HEIGHT = 296;
    
    //each card has 2 pixels between it
    ...
    protected void map()
    {
        //hidden coordinates are at 4 different possible locations, pick 1 random
        super.addMapping(null, null, 0, (int)(Math.random() * 4));
        
        super.addMapping(Suit.Clubs, Value.Ace, 13, 3);
        ...
        super.addMapping(Suit.Diamonds, Value.Ace, 13, 2);
        super.addMapping(Suit.Diamonds, Value.Two, 1, 2);
        super.addMapping(Suit.Diamonds, Value.Three, 2, 2);
        super.addMapping(Suit.Diamonds, Value.Four, 3, 2);
        super.addMapping(Suit.Diamonds, Value.Five, 4, 2);
        super.addMapping(Suit.Diamonds, Value.Six, 5, 2);
        super.addMapping(Suit.Diamonds, Value.Seven, 6, 2);
        super.addMapping(Suit.Diamonds, Value.Eight, 7, 2);
        super.addMapping(Suit.Diamonds, Value.Nine, 8, 2);
        super.addMapping(Suit.Diamonds, Value.Ten, 9, 2);
        super.addMapping(Suit.Diamonds, Value.Jack, 10, 2);
        super.addMapping(Suit.Diamonds, Value.Queen, 11, 2);
        super.addMapping(Suit.Diamonds, Value.King, 12, 2);
        
        super.addMapping(Suit.Hearts, Value.Ace, 13, 0);
        ...
        super.addMapping(Suit.Spades, Value.Ace, 13, 1);

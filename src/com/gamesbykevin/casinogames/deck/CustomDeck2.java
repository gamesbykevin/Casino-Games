...
public final class CustomDeck2 extends Deck
{
    ...
    protected void map()
    {
        ...
        super.addMapping(Suit.Clubs, Value.Two, 1, 0);
        super.addMapping(Suit.Clubs, Value.Three, 2, 0);
        super.addMapping(Suit.Clubs, Value.Four, 3, 0);
        super.addMapping(Suit.Clubs, Value.Five, 4, 0);
        super.addMapping(Suit.Clubs, Value.Six, 5, 0);
        super.addMapping(Suit.Clubs, Value.Seven, 6, 0);
        super.addMapping(Suit.Clubs, Value.Eight, 7, 0);
        super.addMapping(Suit.Clubs, Value.Nine, 8, 0);
        super.addMapping(Suit.Clubs, Value.Ten, 9, 0);
        super.addMapping(Suit.Clubs, Value.Jack, 10, 0);
        super.addMapping(Suit.Clubs, Value.Queen, 11, 0);
        super.addMapping(Suit.Clubs, Value.King, 12, 0);
        ...
        super.addMapping(Suit.Spades, Value.Ace, 0, 3);
        super.addMapping(Suit.Spades, Value.Two, 1, 3);
        super.addMapping(Suit.Spades, Value.Three, 2, 3);
        super.addMapping(Suit.Spades, Value.Four, 3, 3);
        super.addMapping(Suit.Spades, Value.Five, 4, 3);
        super.addMapping(Suit.Spades, Value.Six, 5, 3);
        super.addMapping(Suit.Spades, Value.Seven, 6, 3);
        super.addMapping(Suit.Spades, Value.Eight, 7, 3);
        super.addMapping(Suit.Spades, Value.Nine, 8, 3);
        super.addMapping(Suit.Spades, Value.Ten, 9, 3);
        super.addMapping(Suit.Spades, Value.Jack, 10, 3);
        super.addMapping(Suit.Spades, Value.Queen, 11, 3);
        super.addMapping(Suit.Spades, Value.King, 12, 3);
